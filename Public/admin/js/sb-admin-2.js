...
function orderProcessing(orderID, stringProductID, stringAmountQuantity) {
  ...
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/orderProcessing',
    method: 'post',
    data: {
      orderID: orderID,
...
function loadOrder(orderID) {
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/loadOrder',
    method: 'post',
    data: {
      orderID: orderID
    },
...
function loadListOrder() {
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/loadListOrder',
    method: 'post',
    success: function (response) {
...
function passDataEditOrder(id, name, email, phone, address) {
 ...
 $('#editOrder').click(function () {
  ...
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/editOrder',
    method: 'post',
    data: {
      id: id,
      name: name,
...
function sendFeedback(feedbackID) {
  ...
  if (response.includes('^')) {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/submitFeedback',
      method: 'post',
      data: {
...
function loadFeedback(feedbackID) {
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/loadFeedback',
    method: 'post',
    data: {
      feedbackID: feedbackID
    },
...
function removeItem(type = 0) {
  ...
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/removeItem',
    method: 'post',
    data: {
      itemID: itemID,
      type: type
...
function switchStatus(ID, type = 0) {
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/switchLock',
    method: 'post',
    data: {
      ID: ID,
      type: type
...
function loadProductAdmin() {
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/loadProductAdmin',
    method: 'post',
    success: function (response) {
...
function loadUserAdmin() {
  $.ajax({
    url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/loadUserAdmin',
    method: 'post',
    success: function (response) {
...
(function ($) {
  ...
  $('#editCategory').click(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/editCategory',
      method: 'post',
      data: {
        id: id,
        cateName: cateName,
  ...
  $('#addCategory').click(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/addCategory',
      method: 'post',
      data: {
        cateName: cateName
      },
  ...
  $('#editProduct').click(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/editProduct',
      method: 'post',
      data: formData,
      contentType: false,
      processData: false,
  ...
  $('#addProduct').click(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/addProduct',
      method: 'post',
      data: formData,
      contentType: false,
      processData: false,
  ...
  $('#resetPass').click(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/resetPass',
      method: 'post',
      data: {
        id: id,
        newPass: newPass
  ...
  $('#editUser').click(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/editUser',
      method: 'post',
      data: {
        id: id,
        name: name,
  ...
  $('#addUser').click(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/insertUser',
      method: 'post',
      data: {
        addName: addName,
        addPass: addPass,
  ...
  $('.add-user-form input').keyup(function () {
    ...
    $.ajax({
      url: 'http://localhost/DOTSHOP_CK_WEB/Admin/Ajax/checkNameAdmin',
      method: 'post',
      data: {
        inputName: inputName
      },

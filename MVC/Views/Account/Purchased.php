			...
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						...
						<div class="row mt-2">
							<div class="col-md-12">
								<button onclick="location.href='<?php echo BASE_URL; ?>Account/Purchased';" class="btn btn-secondary">Purchased products</button>
							</div>
						</div>
					</div>
							...
							<div class="purchased-item">
								...
								<?php if ($value['Discount'] > 0): ?>
									<div class="purchased-new-price">
										<label style="font-size:1em;font-weight:bold;margin:0;"><?php echo number_format($value['Price']*($value['Discount']/100),'0','',','); ?></label>
								...
								<?php else: ?>
									<label style="font-size:1em;font-weight:bold;margin:0;"><?php echo number_format($value['Price'],'0','',','); ?></label>
								<?php endif; ?>
							</div>
						<?php endforeach; ?>
					</div>
